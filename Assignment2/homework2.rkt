...
(define b (jpair "banana" (jboolean #t)))
(define a (jpair "apple" (jboolean #t)))
(define c (jpair "coconut" (jboolean #f)))
(define dict (jdict (list a b c)))
...
(test (json->string dict)
      "{\"apple\":true,\"banana\":true,\"coconut\":false}")